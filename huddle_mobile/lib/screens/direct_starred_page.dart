...
class DirectStarredPage extends StatefulWidget {
    final String otherUserId;

    const DirectStarredPage({super.key, required this.otherUserId});

    @override
    State<DirectStarredPage> createState() => _DirectStarredPageState();
}

class _DirectStarredPageState extends State<DirectStarredPage> {
    ...
    Future<void> _loadStarred() async {
        ...
        try {
            final raw = await _storage.read(key: 'starred_dm_${widget.otherUserId}');
